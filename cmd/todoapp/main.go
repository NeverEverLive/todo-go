...
import (
	...
	core_postgres "github.com/NeverEverLive/todo-go/internal/core/repository/postgres"
...
func main() {
	...
	pool, err := core_postgres_pool.NewConnectionPool(ctx, core_postgres.NewConfigMust())
	if err != nil {
